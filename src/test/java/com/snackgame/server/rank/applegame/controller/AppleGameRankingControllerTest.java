    ...
    class 전체_시즌_최고점수_기준 {
        ...
        void 선두_50등을_조회한다() {
            RestAssured.given()
                    ...
                    .body("[2].score", is(20))
                    .body("[3].owner.id", is(베타시즌_땡칠_18점().getOwnerId().intValue()))
                    .body("[3].score", is(18))
                    .body("[4].owner.id", is(베타시즌_똥수_10점().getOwnerId().intValue()))
                    .body("[4].score", is(10))
                    .body("[5].owner.id", is(베타시즌_땡칠_10점().getOwnerId().intValue()))
                    .body("[5].score", is(10))
                    .body("[6].owner.id", is(베타시즌_정환_8점().getOwnerId().intValue()))
                    .body("[6].score", is(8))
                    .body("[7].owner.id", is(베타시즌_정언_8점().getOwnerId().intValue()))
                    .body("[7].score", is(8))
                    .body("[8].owner.id", is(시즌1_정언_8점().getOwnerId().intValue()))
                    .body("[8].score", is(8))
                    .body("[9].owner.id", is(베타시즌_유진_6점().getOwnerId().intValue()))
                    .body("[9].score", is(6));
        }
